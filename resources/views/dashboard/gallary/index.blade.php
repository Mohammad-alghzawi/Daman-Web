...
<div id="app">
    ...
    <section class="is-hero-bar">
      <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
        ...
        <a href="{{ route('gallary.create') }}"><button type="button" class="button light"><i
                      ...
                      <tr>
                          ...
                          <td style="padding: 10px;">
                            <div style="display: flex; justify-content: flex-start; gap: 10px;">
                              <a href="{{route('gallary.edit', $image->id) }}" style="text-decoration: none;">
                              ...
                              <form action="{{route('gallary.destroy', $image->id) }}" method="POST" style="margin: 0; padding: 0;">
                                  @csrf
                                  @method('DELETE')
